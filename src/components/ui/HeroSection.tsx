...
function HeroSection() {
    return <div className='flex mt-20'>
        {/* Left side */}
        <div className='basis-[50%] md:ml-20 mx-auto md:mx-0'>
        ...
        {/* Right Side */}
        <div className='basis-[50%] bg-[#ffece3] rounded-full hidden md:inline mx-5'>
            <Image src={"/header.webp"} alt='header' width={500} height={500} className='mx-[65px] mb-10' />
        </div>
    </div>;
}
