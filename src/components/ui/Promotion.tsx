            ...
            <div className="md:flex justify-center mt-4 py-5">
                ...
                <div className="md:flex gap-x-6 mx-10 md:mx-0 mt-2 md:mt-0">
                    <div className='relative'>
                        <Image src={"/event2.webp"} alt="event" width={205} height={100} className="bg-[#efe1c7] md:ml-6 ml-9 pt-24" />
                    ...
                    <div className='relative'>
                        <Image src={"/event3.webp"} alt="event" width={203} height={100} className="bg-[#d7d7d9] pt-24 ml-9 md:ml-0 mt-2 md:mt-0" />
                        <div className='absolute top-4 left-10 px-10 md:px-0'>
                            Flex Push Button
